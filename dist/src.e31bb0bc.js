...
},{"os":"../node_modules/os-browserify/browser.js"}],"classes/blocks.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      var _this$options2 = this.options,
          s = _this$options2.imageStyles,
          alt = _this$options2.alt,
          styles = _this$options2.styles;
      return (0, _utils.row)("<img alt=\"".concat(alt, "\" src=\"").concat(this.value, "\" style=\"").concat((0, _utils.css)(s), "\" />"), (0, _utils.css)(styles));
    }
  }]);
...
var model = [new _blocks.TitleBlock('Конструктор сайтов на чистом JavaScript', {
  ...
  alt: 'Это картинка'
}), new _blocks.ColumnsBlock(['Продажа яблок', 'Покупка груш', 'Посадка саженцев', 'Срубка деревьев'], {
  styles: {
...
exports.model = model;
},{"./assets/img.jpg":"assets/img.jpg","./classes/blocks":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
